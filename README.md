...
Guide to fix the issues with the very cool handheld device that came originally with Windows when running modern Linux, this is an updated guide based on [JohnJayMcKaye 's guide](https://github.com/JohnJayMcKaye/HIGOLA)
